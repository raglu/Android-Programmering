...
public class MovieActivity extends AppCompatActivity {
    ...
    private MovieFetching moviesFetching;
    private int movieId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moviesFetching = MovieFetching.getInstance();
    ...
    private void getMovie() {
        moviesFetching.getMovie(movieId, new OnGetMovieCallback() {
            @Override
    ...
    private void getGenres(final Movie movie) {
        moviesFetching.getGenres(new OnGetGenresCallback() {
            @Override
